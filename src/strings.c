...
const u8 gText_SilkScarfAndPrice[] = _("Silk Scarf{CLEAR_TO 0x48}1,000 Coins");
const u8 gText_WideLensAndPrice[] = _("Wide Lens{CLEAR_TO 0x48}1,000 Coins");
const u8 gText_ZoomLensAndPrice[] = _("Zoom Lens{CLEAR_TO 0x48}1,000 Coins");
const u8 gText_MetronomeAndPrice[] = _("Metronome{CLEAR_TO 0x48}1,000 Coins");
