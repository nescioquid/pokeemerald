...
const u8 gText_ConfirmStarterChoice[] = _("Choose this POKéMON?");
...
const u8 gText_PowderQty[] = _("There are {STR_VAR_1} units of Berry Powder\nin the jar.{PAUSE_UNTIL_PRESS}");
const u8 gText_AshQty[] = _("There are {STR_VAR_1} units of ashes in the\nsack.{PAUSE_UNTIL_PRESS}");
